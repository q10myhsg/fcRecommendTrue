#mall不使用feather属性 只使用结构化属性
#global
#select x1.mall_id,x1.groupId,x1.categoryId,x1.avgPrice,x1.score,x1.monthlyHits
#from
#(
#select a.mall_id,a.area_id as groupId,a.category_one_id as categoryId,
...
#from fangcheng_global.fc_brand_shop as a,BussinessInfo as b
#where a.dp_id=b.shopId and a.category_one_id is not null and a.mall_id is not null
#group by a.mall_id,groupId,categoryId
#) as x1
#local
